 ...
 * (_](/,(_.|[_)(/,||
 *
 * DeciBell : Model Java Tool for creating and managing relational databases.
 ...
 * MERCHANTABILITY or FITNESS FOR Model PARTICULAR PURPOSE.  See the
...
public class Model extends Component<Model> {
    ...
    public Model(int id, String dataset) {
        this.id = id;
