...
public class RegistrationEngine {
    ...
    private Object getSuperComponent(Object obj) {
        ...
        try {
            Object superObject = obj.getClass().getSuperclass().getDeclaredConstructor().newInstance();
    ...
    private void registerPart(
         ...
         *     L if yes,
         *          Get the corresponding super-object and goto 1.
         * 2. Write the direct sublass of Component into the DB.
         */
