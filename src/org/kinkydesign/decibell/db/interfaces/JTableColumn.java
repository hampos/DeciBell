...
public interface JTableColumn {
    ...
    /**
     * <p align="justify" style="width:60%">
     * If the column is a foreign key, specify the behavior of its
     * values upon deletion. If the column is not a foreing key it is
     * not really affected.
     * </p>
     * @param onDelete
     *      The behavior of the column entries on deletion.
     */
    ...
    /**
     * <p align="justify" style="width:60%">
     * If the column is a foreign key, specify the behavior of its values upon update. If
     * the column is not a foreing key it is not really affected.
     * </p>
     * @param onUpdate
     *      The behavior of the column entries on upate.
     */
    void setOnUpdate(OnModification onUpdate);

    /**
     * <p align="justify" style="width:60%">
     * If this column is a foreign key (references some other column), get
     * the column which is referenced by it, otherwise the method will return
     * <code>null</code>. Check first if the column is a foreign key using the method
     * {@link JTableColumn#isForeignKey() isForeignKey()} to avoid have any
     * <code>NullPointerException</code> thrown.
     * </p>
     * @return
     *      The remote column, i.e. the one referenced by this (if any) or <code>null</code>
    ...
    /**
     * <p align="justify" style="width:60%">
     * Set or update the column which is referenced by this column. Of course the
     * column is rendered a foreign key column. Consider using the method
     * {@link JTableColumn#setForeignKey(org.kinkydesign.decibell.db.interfaces.JTable,
     * org.kinkydesign.decibell.db.interfaces.JTableColumn,
     * org.kinkydesign.decibell.collections.OnModification,
     * org.kinkydesign.decibell.collections.OnModification) setForeignKey} unless you
     * know what you are doing to avoid any kind of inconsistencies.
     * </p>
     * @param referenceColumn
     *      The column that is references by this column.
     */
     ...
     *
     * <p align="justify" style="width:60%">
     * Get the (simple) name of the column that is references by this column. The
     * method returns <code>null</code> if the column is not a foreign key one or
     * the name of the remote column otherwise. This method is provided as a proxy
     * for <code>myColumn.getReferenceColumn().getColumnName()</code>.
     * </p>
     * @return
     *      The (simple) name of the remote column.
     */
    ...
    /**
     * <p align="justify" style="width:60%">
     * Whether some higher bound constraint is imposed on the column
     * </p>
     * @return
     *      <code>true</code> if there is an upper bound constraint imposed
     *      and <code>false</code> otherwise.
     */
    boolean hasHigh();
    ...
    /**
     * <p align="justify" style="width:60%">
     * Whether some lower bound constraint is imposed on the column
     * </p>
     * @return
     *      <code>true</code> if there is a lower bound constraint imposed
     *      and <code>false</code> otherwise.
     */
    boolean hasLow();
     ...
     *
     * <p align="justify" style="width:60%">
     * Specify whether the column is autogenerated. If auto-generation is activated
     * the values in that are <em>always</em> generated as identity and you cannot
     * manually specify their value. Only columns of type {@link SQLType#BIGINT bigInt}
     * of {@link SQLType#INTEGER integer} are allowed to be auto-generated but in some
     * next version of DeciBell we will add support for String-type auto-generated
     * columns using <code>UUID</code>s.
     * </p>
     * @param autoGenerated
    ...
    /**
     * <p align="justify" style="width:60%">
     * Specify the class that is references by this table column which obviously
     * means that the this column is rendered a foreign key.
     * </p>
     * @param referencesClass
     *      Class that is referenced by this column.
     */
